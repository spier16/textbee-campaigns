...
export const PREDEFINED_PLANS = [
  ...
  },
  {
    ...
    tierPromotionCooldownHours: 0, // No cooldown for testing
    tiers: [
      { tier: 1, avg_wait_seconds: 50, messages_per_cycle: 3 },
      { tier: 2, avg_wait_seconds: 40, messages_per_cycle: 4 },
      { tier: 3, avg_wait_seconds: 30, messages_per_cycle: 5 },
    ],
    isDefault: false,
    isActive: true,
    isTemplate: true,
