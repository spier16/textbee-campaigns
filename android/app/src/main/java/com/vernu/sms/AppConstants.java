...
public class AppConstants {
    ...
    public static final String SHARED_PREFS_PHONE_NUMBER_SIM_1_KEY = "PHONE_NUMBER_SIM_1";
    public static final String SHARED_PREFS_PHONE_NUMBER_SIM_2_KEY = "PHONE_NUMBER_SIM_2";
    public static final String SHARED_PREFS_PHONE_NUMBER_MANUALLY_SET_1_KEY = "PHONE_NUMBER_MANUALLY_SET_1";
    public static final String SHARED_PREFS_PHONE_NUMBER_MANUALLY_SET_2_KEY = "PHONE_NUMBER_MANUALLY_SET_2";
}
